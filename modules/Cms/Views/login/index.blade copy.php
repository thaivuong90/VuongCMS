...
<body>
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      @endif
      <form class="space-y-6" action="{{ route('cms.login.authenticate') }}" method="POST">
        @csrf
        <div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        <a href="{{ route('cms.register') }}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Create new account</a>
      </p>
    </div>
  </div>
</body>
