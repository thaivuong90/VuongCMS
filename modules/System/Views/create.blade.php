  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        @endif
        <form action="{{ system_route('system.store') }}" method="post" enctype="multipart/form-data">
          @csrf
          <p class="login-box-msg">{{ trans('common.label.info') }}</p>
          <div class="mb-3">
            <input type="text" name="name" class="form-control" placeholder="{{ trans('common.label.name') }}" value="{{ old('name') }}">
          </div>
          <div class="mb-3">
            <input type="text" name="slug" class="form-control" placeholder="{{ trans('common.label.slug') }}" value="{{ old('slug') }}">
          </div>
          <div class="mb-3">
            <input type="text" name="username" class="form-control" placeholder="{{ trans('common.label.username') }}" value="{{ old('username') }}">
          </div>
          <div class="mb-3">
            <input type="text" name="cccd" class="form-control" placeholder="{{ trans('common.label.cccd') }}" value="{{ old('cccd') }}">
          </div>
          <div class="mb-3">
            <input type="text" name="phone" class="form-control" placeholder="{{ trans('common.label.phone') }}" value="{{ old('phone') }}">
          </div>
          <div class="mb-3">
            <input type="text" name="address" class="form-control" placeholder="{{ trans('common.label.address') }}" value="{{ old('address') }}">
          </div>
          <div class="mb-3">
